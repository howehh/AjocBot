...
function connectToCytube(serverUrl) { 
   socketConnect = sc.connect(serverUrl, {
      secure: true
   });
...
// Attemps to find the socket URL of the cytube channel. Returns the url
// if successful and throws an exception if not.
function getSocketURL(callback) {
